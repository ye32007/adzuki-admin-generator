...
public class AdzukiMapperPlugin extends AdzukiFalseMethodPlugin{
    ...
    private void processEntityClass(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
	    ...
	    if("jpa".equals(genType)){
	    	topLevelClass.addAnnotation("@Entity");//JPA
	    }
    ...
    public void setProperties(Properties properties) {
        ...
        String genType = this.properties.getProperty("genType");
        if (StringUtility.stringHasValue(genType) && (genType.equals("mybatis") || genType.equals("jpa"))) {
